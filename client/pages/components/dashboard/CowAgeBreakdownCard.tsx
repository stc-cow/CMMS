  ...
  return (
    <div className="bg-card border border-border rounded-lg p-6 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-semibold text-foreground">New vs Old COWs</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-3">
          ...
          >
            <p className="text-sm font-medium text-muted-foreground mb-1">New COWs</p>
            <p className="text-4xl font-bold text-green-600 group-hover:text-green-700 transition-colors">
              {data.new}
            </p>
            <div className="mt-2 w-full bg-secondary rounded-full h-2">
              <div className="bg-green-500 h-full rounded-full" style={{ width: `${newPercentage}%` }} />
            </div>
            <p className="text-xs text-muted-foreground mt-1">{newPercentage.toFixed(1)}%</p>
          </button>
          ...
          >
            <p className="text-sm font-medium text-muted-foreground mb-1">Old COWs</p>
            <p className="text-4xl font-bold text-orange-600 group-hover:text-orange-700 transition-colors">
              {data.old}
            </p>
            <div className="mt-2 w-full bg-secondary rounded-full h-2">
              <div className="bg-orange-500 h-full rounded-full" style={{ width: `${oldPercentage}%` }} />
            </div>
            <p className="text-xs text-muted-foreground mt-1">{oldPercentage.toFixed(1)}%</p>
          </button>
        </div>
